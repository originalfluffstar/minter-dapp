const contractAddress = "0x1804A314a5bfb3A8B177eCf9f8de711bD60cc27a"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Crazy Cool Cat Club NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'This is the initial deployment of 100 from the Crazy Cool Cat Club project';
